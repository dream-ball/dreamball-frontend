...
import { server, display_loading, display_error } from "../../utils/utils";
export default function Contest() {
    ...
    const [prize_detail, set_prize_detail] = useState([]);
    ...
    }, [id, fetchMatchData, fetchContests, fetchRegisteredMatchData, navigate, error]);
            ...
            {loading ? display_loading(true) : error ? (
                ...
                <>
                    ...
                    <div className="team-header">
                        <div className="teams">
                            <div className="img_container">
                                <img id="team1_img" src={matchData?.team_a_img} alt="" />
                            </div>
                            ...
                            <div className="img_container2">
                                <img id="team2_img" src={matchData?.team_b_img} alt="" />
                            </div>
                    ...
                    <div className="contest_join">
                        ...
                        <div className="text">Select a contest to join</div>
                    ...
                    <div className="contest_con">
                        ...
                        {contests.length > 0 ? (
                            ...
                            contests.map((contest, index) => {
                                const UserJoined = userMatch.length ? (userMatch.some(obj => Number(obj.contest_id) === Number(contest.contest_id))) : false;
                                return (
                                    <ContestCard key={contest.contest_id} contest={contest} registerContest={registerContest} prize_detail={prize_detail[index]} join={UserJoined} />
                                )
                            })
                        ) : (
                            <p>{display_loading(true)}</p>
                        )}
                    </div>
                </>
            )}
