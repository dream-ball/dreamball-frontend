...
const ViewContestCard = ({ matchData, contests, prize_detail, registerContest, join, timeRemaining, maxFill, currentFill, contestType }) => {
            ...
            {contestType === "practice contest" ? <div className='ranking_board' id="ranking_board">
              ...
              <div className='ranking_board' id="ranking_board">
                ...
                <div className="container">
                  ...
                  {currentFill.data?<div className='current_fill' id="current_fill" style={{width:"100%",padding:"20px 0px"}}>
                    ...
                    {currentFill.map((item, index) => (
                      <div className="row" key={index}>
                        <div className="rank">{item.rank}</div>
                        <div className="winnings">{item.winnings}</div>
                      </div>
                    ))}
                  </div>}
