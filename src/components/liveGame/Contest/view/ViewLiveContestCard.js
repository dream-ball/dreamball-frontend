      ...
      <div className="view_con">
        <div className="view_main_con">
          <div className="view view_cnt_card" id="1">
            ...
            {contestType === "practice contest" ? <div className='ranking_board_live' id="ranking_board">
              ...
              <div className='ranking_board_live' id="ranking_board">

                <div className="container">
                  <div className='final_break_up'>Final Prize Breakup</div>

                  {currentFill.data ? <div className='current_fill_live' id="current_fill" style={{ width: "100%", padding: "20px 0px" }}>
                    <div className='no_fill_msg'>{currentFill.data}</div>
                  </div> : <div id='current_fill_live' className='current_fill_live'>
            ...
            <div className='players_board_live' id="players_board">
              <div className='teams_count'>
                <p className='info'>All Teams(12,21,983)</p>
              </div>
            </div>
          </div>
        </div>
...
export default ViewLiveContestCard;
